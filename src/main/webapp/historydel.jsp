...
<body>
<%	
	Integer rown = Integer.valueOf(request.getParameter("hiddenvalue"));
	history2dbVer01 hiSel = new history2dbVer01();
	List<String> tmpList = hiSel.dbSelect();
	hiSel.dbDel(tmpList.get(rown * 4 - 1));
	
	history2dbVer01 hiSel2 = new history2dbVer01();
	List<String> result = hiSel2.dbSelect();
